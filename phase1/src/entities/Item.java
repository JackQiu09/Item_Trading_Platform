...
public class Item implements Serializable {
    ...
    public String toString() {
        ...
        itemString.append("===================================" + "\n");
        itemString.append("Item ID: " + itemId + "\n");
        itemString.append("Item Name: " + itemName + "\n");
        itemString.append("Description: " + description + "\n");
        itemString.append("Owner: " + ownerName + "\n");
        itemString.append("Type: " + type + "\n");
        itemString.append("===================================" + "\n");
