...
public class FileReadAndWrite {
    ...
    public final static String CLIENT_USER_FILE = "./phase1/src/database/client_users.ser";
    //public final static String ADMIN_USER_FILE = "admin_users.csv";
    public final static String ADMIN_USER_FILE = "./phase1/src/database/admin_users.ser";
    ...
    public final static String EDIT_TRADE_PROMPT = "/database/editTradePrompt.txt";
    public final static String CONFIRM_TRANSACTION_PROMPT = "/database/confirmTransactionPrompt.txt";
    public final static String CONFIRM_TRANSACTION_OPTIONS_PROMPT = "/database/confirmTransactionOptionsPrompt.txt";

    // Threshold manager
    public final static String THRESHOLD_MANAGER_FILE = "./phase1/src/database/thresholds.ser";
    ...
    public final static String APPOINTMENTS_FILE = "./phase1/src/database/appointments.ser";
    ...
    private final static String filePath = "./phase1/src/";
